"""
Django settings for Moisha_Back project.
...
SECRET_KEY = '58dzq(^nu7s8hv90-a)zfhdiiaua4!csn(s*ldx5@j@)bvfu)1'
...
WSGI_APPLICATION = 'Moisha_Back.wsgi.application'
