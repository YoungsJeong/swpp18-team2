...
class CommentTestCase(TestCase):
    ...
    def testCreateComment(self):
        ...
        response = self.client.post('/comment/', correctData, content_type='application/json')
        self.assertEqual(response.status_code, 400)
        self.client.login(username='test@test.com', password='test')
        response = self.client.post('/comment/', correctData, content_type='application/json')
        self.assertEqual(response.status_code, 200)
        response = self.client.post('/comment/', wrongData, content_type='application/json')
        self.assertEqual(response.status_code, 400)
    ...
    def testEditComment(self):
        ...
        response = self.client.put('/comment/1/', dataWithOutParent, content_type='application/json')
        self.assertEqual(response.status_code, 400)
        self.client.login(username='test@test.com', password='test')
        response = self.client.put('/comment/1/', dataWithOutParent, content_type='application/json')
        self.assertEqual(response.status_code, 200)
        response = self.client.delete('/comment/1/', dataWithOutParent, content_type='application/json')
        self.assertEqual(response.status_code, 200)
        response = self.client.delete('/comment/2/', dataWithOutParent, content_type='application/json')
        self.assertEqual(response.status_code, 200)
        response = self.client.delete('/comment/3/', dataWithOutParent, content_type='application/json')
        self.assertEqual(response.status_code, 200)
        response = self.client.delete('/comment/4/', content_type='application/json')
        self.assertEqual(response.status_code, 400)